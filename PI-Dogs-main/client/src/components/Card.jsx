    ...
    return (
     <div className='cards'>
        <div className='card_imagen'>
            ...
            <img className='img' src={image?.url ? image?.url:"https://st3.depositphotos.com/9494100/15431/i/600/depositphotos_154313516-stock-photo-pug-dog-with-yellow-constructor.jpg"} alt="img not found" width='100%' />
        </div>
